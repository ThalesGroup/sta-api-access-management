...
{
    /// <summary>
    /// It receives a set of allowed and denied methods, and generates a valid AWS policy for the API Gateway authorizer.
    /// </summary>
    public class AuthPolicyBuilder
    {
        ...
        /// <summary>
        /// The AWS account ID that the policy will be generated for. This is used to create the method ARNs.
        /// </summary>
        ...
        /// <param name="apiOptions">It comprises an API identifier, a Region for the RestApi, and the Stage of the API deployment</param>
